##  Setup Kubernetes [Kubeadm] Cluster (Version: 1.35)
...
sudo apt-get update -y
sudo apt-get install -y kubelet="1.35.0-*" kubectl="1.35.0-*" kubeadm="1.35.0-*"
sudo apt-get update -y
